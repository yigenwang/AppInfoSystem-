...
public class AppServiceImpl implements AppService {
	...
	public List<AppInfo> getAppInfoList(String querySoftwareName,
		...
		// TODO Auto-generated method stub
		return mapper.getAppInfoList(querySoftwareName, 1, queryFlatformId, queryCategoryLevel1, queryCategoryLevel2, 
				                 queryCategoryLevel3, null, (currentPageNo-1)*pageSize, pageSize);
	}
